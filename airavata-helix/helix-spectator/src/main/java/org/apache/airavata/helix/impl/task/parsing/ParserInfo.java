...
public class ParserInfo {
    ...
    // todo take an input for the *Mandatory output files. Then should check once the task is run whether the output
    // todo files have been created

    //todo about the names of the inputs and outputs files --> rely on the user Assume that user will correctly define them
    // todo so that a parser in the middle will correctly get the inputs as defined in the output names of previous one
